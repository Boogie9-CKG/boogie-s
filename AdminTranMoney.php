...
<?php
 $SQL2 = "SELECT * FROM tblcashflow WHERE (Items = 'Booking' OR Items = 'Refund' OR Items = 'Income')    ";
...
<div style="padding: 10px 120px 1000px;">
  ...
  <caption><strong>Transaction Record</strong></caption>
  <thead>
		<tr>
	  ...
	  while($Row2 = mysql_fetch_array($Result2)) {
	    ...
	    <tr>
	      ...
	      <td align="center"><?php echo $Row2['OperationDate'] ?></td>
				...
				<td align="center"><?php echo number_format($Row2['Amount']);
